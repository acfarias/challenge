...
namespace Challenge.IntegrationTests.Configuration
{
    ...
    public class OrderTestAttribute : Attribute
    {
        public OrderTestAttribute(int priority)
        {
            Priority = priority;
        }
    ...
    public class PriorityOrderer : ITestCaseOrderer
    {
        public IEnumerable<TTestCase> OrderTestCases<TTestCase>(IEnumerable<TTestCase> testCases) where TTestCase : ITestCase
        {
            ...
            foreach (var testCase in testCases)
            {
                ...
                foreach (var attr in testCase.TestMethod.Method.GetCustomAttributes(typeof(OrderTestAttribute).AssemblyQualifiedName))
